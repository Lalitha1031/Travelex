...
$c=$_POST["cvv"]; //cvv
/*$td1="create table beachbooking(id int(3)UNSIGNED AUTO_INCREMENT PRIMARY KEY,username varchar(100),
...
$in="insert into beachbooking(username,email,place_package,number_of_person,date_day,payment,cardno,
