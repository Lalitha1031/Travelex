...
$c=$_POST["cvv"]; //cvv
/*$td1="create table palsebooking(id int(3)UNSIGNED AUTO_INCREMENT PRIMARY KEY,username varchar(100),
...
$in="insert into palsebooking(username,email,place_package,number_of_person,date_day,payment,cardno,
